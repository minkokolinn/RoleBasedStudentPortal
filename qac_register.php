...
if (isset($_POST['enter'])) {
	...
	if ($check->rowCount() > 0) {
		...
		$insert = "INSERT INTO qac (qacName,qacPhone,qacEmail,qacPassword,qacAddress,status,deptId) values (:name,:phone,:email,:password,:address,:status,:deptId)";
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block text-center">
						...
						<h1 class="text-capitalize mb-5 text-lg">QA Coordinator Register</h1>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12 col-sm-12">
					<form method="post" action="qac_register.php">
