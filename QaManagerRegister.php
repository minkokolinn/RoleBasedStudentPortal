...
if (isset($_POST['enter'])) {
	...
	{	
		$insert="INSERT INTO qam (qamName,qamPhone,qamEmail,qamPassword,qamAddress,status) 
                values (:name,:phone,:email,:password,:address,:status)";
...
<head>
    ...
    <title>Qa Manager Register</title>
</head>
<body>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <h1 class="text-capitalize mb-5 text-lg">Qa Manager Register</h1>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12" >
                <form method="post" action="QaManagerRegister.php">
